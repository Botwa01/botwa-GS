...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'TEL;type=CELL;type=VOICE;waid=6285855205638:+62 882-2160-8614\n'//GANTI NOMOR LU
            + 'END:VCARD'
...
async function starts() {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			const ownerNumber = [
			"6285855205638@s.whatsapp.net","6285776452394@s.whatsapp.net"
			]
			premium = [
			"6288221608614@s.whatsapp.net","6283102650464@s.whatsapp.net"
			]
		...
		case 'daftar':
			...
			case 'Yon':
                ...
                setTimeout( () => {
					...
					setTimeout( () => {*/
					client.sendMessage(from, 'Terimakasih sudah menggunakan *Yon_ShopBot* \n\n*SEBAGAI PENGGANTI DONASI YUK SUPORT*\nSubscribe https://youtube.com/c/Deon saputra \nFollow instagram https://instagram.com/yon_shopff', text, {quoted: mek})
					}, 0)
    				break
/*********PISAH MENU**********/
              case 'ownermenu':
